CREATE DATABASE IF NOT EXISTS DBJTGDWESAplicacionFinal;
...
CREATE USER IF NOT EXISTS 'userJTGDWESAplicacionFinal'@'%' IDENTIFIED BY 'paso';
GRANT ALL PRIVILEGES ON DBJTGDWESAplicacionFinal.* TO 'userJTGDWESAplicacionFinal'@'%';
FLUSH PRIVILEGES;