...
<section class="hero-text">
    ...
    <form action="" method="post">
        ...
        <input type="text" id="desc" name="desc" value="<?= $avEditDep["descripcion"] ?>" obligatorio>
        ...
        <input type="text" id="volumenNegocio" name="volumenNegocio" value="<?= $avEditDep["volumenNegocio"] ?>" obligatorio>

        <label for="fechaBaja">Fecha de Baja:</label>
        <input type="text" id="fechaBaja" name="fechaBaja" value="<?= $avEditDep["fechaBaja"] ?>" readonly disabled>

        <?php if (empty($avEditDep["fechaBaja"])): ?>
